...
namespace ExamScoringApp.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            ...
            {
                var user = new ApplicationUser { UserName = userViewModel.Email, Email = userViewModel.Email,StudentNo=userViewModel.StudentNo, StudentName = userViewModel.StudentName };
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,StudentNo,StudentName")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
                ...
                user.StudentNo = editUser.StudentNo;
                user.StudentName = editUser.StudentName;
                ...
                await IdentityContext.Users.ReplaceOneAsync(t => t.Id.Equals(new ObjectId(user.Id)), user, new UpdateOptions { IsUpsert = true });
